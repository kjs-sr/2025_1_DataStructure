...
class DisjointSet: # 크루스칼 알고리즘을 위한 유틸리티 클래스
    def __init__(self,n):
        self.parent = [i for i in range(n)] # n=6, [0, 1, 2, 3, 4, 5]

    def find(self, z):
        if self.parent[z] != z:
            self.parent[z] = self.find(self.parent[z])
...
incheon, seoul, gangrueng, daejeon, gwangju, busan = 0, 1, 2, 3, 4, 5


graph_size = 6
g1 = Graph(graph_size)
g1.graph[incheon][seoul] = 10; g1.graph[incheon][gangrueng] = 15
g1.graph[seoul][incheon] = 10; g1.graph[seoul][gangrueng] = 40; g1.graph[seoul][daejeon] = 11; g1.graph[seoul][gwangju] = 55
g1.graph[gangrueng][incheon] = 15; g1.graph[gangrueng][seoul] = 40; g1.graph[gangrueng][daejeon] = 12
g1.graph[daejeon][seoul] = 11; g1.graph[daejeon][gangrueng] = 12; g1.graph[daejeon][gwangju] = 20; g1.graph[daejeon][busan] = 30
